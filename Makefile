...
chain-types:
	rm -rf chain && mkdir chain chain/types chain/app chain/indexer chain/modules chain/modules/fnft chain/modules/fnft/types chain/modules/bazaar chain/modules/bazaar/types chain/modules/evm chain/modules/evm/types chain/stream chain/stream/types
