...
func (inst *Initialize) SetQuoteAssetMintAccount(quoteAssetMint ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(quoteAssetMint)
	return inst
}

// GetQuoteAssetMintAccount gets the "quoteAssetMint" account.
func (inst *Initialize) GetQuoteAssetMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetDriftSignerAccount sets the "driftSigner" account.
func (inst *Initialize) SetDriftSignerAccount(driftSigner ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(driftSigner)
	return inst
}

// GetDriftSignerAccount gets the "driftSigner" account.
func (inst *Initialize) GetDriftSignerAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=7]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("quoteAssetMint", inst.AccountMetaSlice.Get(2)))
