...
func (inst *Withdraw) SetMarketIndex(marketIndex uint16) *Withdraw {
...
func (inst *Withdraw) SetReduceOnly(reduceOnly bool) *Withdraw {
...
func (inst *Withdraw) SetUserStatsAccount(userStats ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(userStats).WRITE()
	return inst
}

// GetUserStatsAccount gets the "userStats" account.
func (inst *Withdraw) GetUserStatsAccount() *ag_solanago.AccountMeta {
...
func (inst *Withdraw) SetSpotMarketVaultAccount(spotMarketVault ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(spotMarketVault).WRITE()
	return inst
}

// GetSpotMarketVaultAccount gets the "spotMarketVault" account.
func (inst *Withdraw) GetSpotMarketVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetDriftSignerAccount sets the "driftSigner" account.
func (inst *Withdraw) SetDriftSignerAccount(driftSigner ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(driftSigner)
	return inst
}

// GetDriftSignerAccount gets the "driftSigner" account.
func (inst *Withdraw) GetDriftSignerAccount() *ag_solanago.AccountMeta {
...
func (inst *Withdraw) SetUserTokenAccountAccount(userTokenAccount ag_solanago.PublicKey) *Withdraw {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(userTokenAccount).WRITE()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Withdraw")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=8]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      userToken", inst.AccountMetaSlice.Get(6)))
