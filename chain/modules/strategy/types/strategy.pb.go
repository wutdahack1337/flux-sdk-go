...
type StrategyMetadata struct {
	...
	AggregatedQueryKeys []string `protobuf:"bytes,8,rep,name=aggregated_query_keys,json=aggregatedQueryKeys,proto3" json:"aggregated_query_keys,omitempty" bson:"aggregated_query_keys"`
	// Strategy gas price, only applicable for cron bots now
	CronGasPrice cosmossdk_io_math.Int `protobuf:"bytes,9,opt,name=cron_gas_price,json=cronGasPrice,proto3,customtype=cosmossdk.io/math.Int" json:"cron_gas_price" bson:"cron_gas_price"`
	// input to control cron bots
	CronInput string `protobuf:"bytes,10,opt,name=cron_input,json=cronInput,proto3" json:"cron_input,omitempty" bson:"cron_input"`
	// timestamp interval (s) to trigger cron bots
	CronInterval uint64 `protobuf:"varint,11,opt,name=cron_interval,json=cronInterval,proto3" json:"cron_interval,omitempty" bson:"cron_interval"`
	// declares interacted dapps so that app owner can verify and we know which
	// bot is serving what dapp
	SupportedApps []*SupportedApp `protobuf:"bytes,12,rep,name=supported_apps,json=supportedApps,proto3" json:"supported_apps,omitempty" bson:"supported_apps"`
}
...
type StrategyEvent struct {
	Op         types1.Op `protobuf:"varint,1,opt,name=op,proto3,enum=flux.eventstream.v1beta1.Op" json:"op,omitempty" json:"op,omitempty"`
	StrategyId string    `protobuf:"bytes,2,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty" bson:"strategy_id"`
	Topic      string    `protobuf:"bytes,3,opt,name=topic,proto3" json:"topic,omitempty"`
	Data       []byte    `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`
}

func (m *StrategyEvent) Reset()         { *m = StrategyEvent{} }
func (m *StrategyEvent) String() string { return proto.CompactTextString(m) }
func (*StrategyEvent) ProtoMessage()    {}
func (*StrategyEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7aed9d1e3bd608e, []int{10}
}
func (m *StrategyEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StrategyEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StrategyEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StrategyEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StrategyEvent.Merge(m, src)
}
func (m *StrategyEvent) XXX_Size() int {
	return m.Size()
}
func (m *StrategyEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_StrategyEvent.DiscardUnknown(m)
}

var xxx_messageInfo_StrategyEvent proto.InternalMessageInfo

func (m *StrategyEvent) GetOp() types1.Op {
	if m != nil {
		return m.Op
	}
	return types1.Op_COSMOS_SET
}

func (m *StrategyEvent) GetStrategyId() string {
	if m != nil {
		return m.StrategyId
	}
	return ""
...
func (m *StrategyEvent) GetTopic() string {
	if m != nil {
		return m.Topic
	}
	return ""
...
func (m *StrategyEvent) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
type StrategyOutput struct {
	...
	Events       []*StrategyEvent        `protobuf:"bytes,2,rep,name=events,proto3" json:"events,omitempty"`
...
func (m *StrategyOutput) GetEvents() []*StrategyEvent {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *StrategyOutput) GetResult() string {
	if m != nil {
		return m.Result
	}
	return ""
...
func (*SupportedApp) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7aed9d1e3bd608e, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*StrategyEvent)(nil), "flux.strategy.v1beta1.StrategyEvent")
	golang_proto.RegisterType((*StrategyEvent)(nil), "flux.strategy.v1beta1.StrategyEvent")
...
var fileDescriptor_a7aed9d1e3bd608e = []byte{
	...
	,
}
...
func (m *StrategyEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StrategyEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StrategyEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Topic) > 0 {
		i -= len(m.Topic)
		copy(dAtA[i:], m.Topic)
		i = encodeVarintStrategy(dAtA, i, uint64(len(m.Topic)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.StrategyId) > 0 {
		...
		i = encodeVarintStrategy(dAtA, i, uint64(len(m.StrategyId)))
		i--
		dAtA[i] = 0x12
	}
	if m.Op != 0 {
		i = encodeVarintStrategy(dAtA, i, uint64(m.Op))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StrategyOutput) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		...
		i = encodeVarintStrategy(dAtA, i, uint64(len(m.Result)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Events) > 0 {
...
func (m *StrategyEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StrategyEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StrategyEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StrategyEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *StrategyOutput) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Events = append(m.Events, &StrategyEvent{})
