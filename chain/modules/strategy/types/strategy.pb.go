...
type StrategyMetadata struct {
	...
	CronInterval string `protobuf:"bytes,10,opt,name=cron_interval,json=cronInterval,proto3" json:"cron_interval,omitempty"`
}
...
func (m *StrategyMetadata) GetCronInterval() string {
	if m != nil {
...
var fileDescriptor_a7aed9d1e3bd608e = []byte{
	...
	,
}
...
func (m *StrategyMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CronInterval) > 0 {
		i -= len(m.CronInterval)
		copy(dAtA[i:], m.CronInterval)
		i = encodeVarintStrategy(dAtA, i, uint64(len(m.CronInterval)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *StrategyMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.CronInterval = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStrategy(dAtA[iNdEx:])
