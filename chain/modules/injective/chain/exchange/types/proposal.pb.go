...
func (ExchangeType) Descriptor() protoreflect.EnumDescriptor {
	return file_injective_exchange_v1beta1_proposal_proto_enumTypes[0].Descriptor()
}

func (ExchangeType) Type() protoreflect.EnumType {
	return &file_injective_exchange_v1beta1_proposal_proto_enumTypes[0]
}
...
func (ExchangeType) EnumDescriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{0}
}
...
func (x *SpotMarketParamUpdateProposal) Reset() {
	*x = SpotMarketParamUpdateProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[0]
...
func (x *ExchangeEnableProposal) Reset() {
	*x = ExchangeEnableProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeEnableProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{1}
}
...
func (x *BatchExchangeModificationProposal) Reset() {
	*x = BatchExchangeModificationProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchExchangeModificationProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{2}
}
...
func (x *SpotMarketLaunchProposal) Reset() {
	*x = SpotMarketLaunchProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpotMarketLaunchProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{3}
}
...
func (x *PerpetualMarketLaunchProposal) Reset() {
	*x = PerpetualMarketLaunchProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PerpetualMarketLaunchProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{4}
}
...
func (x *BinaryOptionsMarketLaunchProposal) Reset() {
	*x = BinaryOptionsMarketLaunchProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BinaryOptionsMarketLaunchProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{5}
}
...
func (x *ExpiryFuturesMarketLaunchProposal) Reset() {
	*x = ExpiryFuturesMarketLaunchProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExpiryFuturesMarketLaunchProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{6}
}
...
func (x *DerivativeMarketParamUpdateProposal) Reset() {
	*x = DerivativeMarketParamUpdateProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DerivativeMarketParamUpdateProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{7}
}
...
func (x *AdminInfo) Reset() {
	*x = AdminInfo{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdminInfo) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{8}
}
...
func (x *MarketForcedSettlementProposal) Reset() {
	*x = MarketForcedSettlementProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MarketForcedSettlementProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{9}
}
...
func (x *UpdateDenomDecimalsProposal) Reset() {
	*x = UpdateDenomDecimalsProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateDenomDecimalsProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{10}
}
...
func (x *BinaryOptionsMarketParamUpdateProposal) Reset() {
	*x = BinaryOptionsMarketParamUpdateProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BinaryOptionsMarketParamUpdateProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{11}
}
...
func (x *ProviderOracleParams) Reset() {
	*x = ProviderOracleParams{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProviderOracleParams) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{12}
}
...
func (x *OracleParams) Reset() {
	*x = OracleParams{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OracleParams) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{13}
}
...
func (x *TradingRewardCampaignLaunchProposal) Reset() {
	*x = TradingRewardCampaignLaunchProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TradingRewardCampaignLaunchProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{14}
}
...
func (x *TradingRewardCampaignUpdateProposal) Reset() {
	*x = TradingRewardCampaignUpdateProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TradingRewardCampaignUpdateProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{15}
}
...
func (x *RewardPointUpdate) Reset() {
	*x = RewardPointUpdate{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RewardPointUpdate) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{16}
}
...
func (x *TradingRewardPendingPointsUpdateProposal) Reset() {
	*x = TradingRewardPendingPointsUpdateProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TradingRewardPendingPointsUpdateProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{17}
}
...
func (x *FeeDiscountProposal) Reset() {
	*x = FeeDiscountProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeeDiscountProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{18}
}
...
func (x *BatchCommunityPoolSpendProposal) Reset() {
	*x = BatchCommunityPoolSpendProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchCommunityPoolSpendProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{19}
}
...
func (x *AtomicMarketOrderFeeMultiplierScheduleProposal) Reset() {
	*x = AtomicMarketOrderFeeMultiplierScheduleProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AtomicMarketOrderFeeMultiplierScheduleProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{20}
}
...
func (x *DenomMinNotionalProposal) Reset() {
	*x = DenomMinNotionalProposal{}
	mi := &file_injective_exchange_v1beta1_proposal_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DenomMinNotionalProposal) Descriptor() ([]byte, []int) {
	return file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP(), []int{21}
}
...
var File_injective_exchange_v1beta1_proposal_proto protoreflect.FileDescriptor

const file_injective_exchange_v1beta1_proposal_proto_rawDesc = "" +
	"\n" +
	")injective/exchange/v1beta1/proposal.proto\x12\x1ainjective.exchange.v1beta1\x1a\x1ecosmos/base/v1beta1/coin.proto\x1a.cosmos/distribution/v1beta1/distribution.proto\x1a\x17cosmos/msg/v1/msg.proto\x1a\x19cosmos_proto/cosmos.proto\x1a\x14gogoproto/gogo.proto\x1a)injective/exchange/v1beta1/exchange.proto\x1a%injective/oracle/v1beta1/oracle.proto\x1a\x11amino/amino.proto\"\x9f\a\n" +
	...
	"\x06status\x18\t \x01(\x0e2(.injective.exchange.v1beta1.MarketStatusR\x06status\x12\x1c\n" +
	"\x06ticker\x18\n" +
	" \x01(\tB\x04\xc8\xde\x1f\x01R\x06ticker\x12F\n" +
	"\fmin_notional\x18\v \x01(\tB#\xc8\xde\x1f\x01\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\vminNotional\x12D\n" +
	"\n" +
	"admin_info\x18\f \x01(\v2%.injective.exchange.v1beta1.AdminInfoR\tadminInfo\x12#\n" +
	"\rbase_decimals\x18\r \x01(\rR\fbaseDecimals\x12%\n" +
	"\x0equote_decimals\x18\x0e \x01(\rR\rquoteDecimals:Q\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*&exchange/SpotMarketParamUpdateProposal\"\xcc\x01\n" +
	"\x16ExchangeEnableProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12L\n" +
	"\fexchangeType\x18\x03 \x01(\x0e2(.injective.exchange.v1beta1.ExchangeTypeR\fexchangeType:,\x88\xa0\x1f\x00\xe8\xa0\x1f\x00\x8a\xe7\xb0*\x1fexchange/ExchangeEnableProposal\"\x8b\x0e\n" +
	"!BatchExchangeModificationProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x85\x01\n" +
	"\"spot_market_param_update_proposals\x18\x03 \x03(\v29.injective.exchange.v1beta1.SpotMarketParamUpdateProposalR\x1espotMarketParamUpdateProposals\x12\x97\x01\n" +
	"(derivative_market_param_update_proposals\x18\x04 \x03(\v2?.injective.exchange.v1beta1.DerivativeMarketParamUpdateProposalR$derivativeMarketParamUpdateProposals\x12u\n" +
	"\x1cspot_market_launch_proposals\x18\x05 \x03(\v24.injective.exchange.v1beta1.SpotMarketLaunchProposalR\x19spotMarketLaunchProposals\x12\x84\x01\n" +
	"!perpetual_market_launch_proposals\x18\x06 \x03(\v29.injective.exchange.v1beta1.PerpetualMarketLaunchProposalR\x1eperpetualMarketLaunchProposals\x12\x91\x01\n" +
	"&expiry_futures_market_launch_proposals\x18\a \x03(\v2=.injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposalR\"expiryFuturesMarketLaunchProposals\x12\x95\x01\n" +
	"'trading_reward_campaign_update_proposal\x18\b \x01(\v2?.injective.exchange.v1beta1.TradingRewardCampaignUpdateProposalR#tradingRewardCampaignUpdateProposal\x12\x91\x01\n" +
	"&binary_options_market_launch_proposals\x18\t \x03(\v2=.injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposalR\"binaryOptionsMarketLaunchProposals\x12\x94\x01\n" +
	"%binary_options_param_update_proposals\x18\n" +
	" \x03(\v2B.injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposalR!binaryOptionsParamUpdateProposals\x12|\n" +
	"\x1edenom_decimals_update_proposal\x18\v \x01(\v27.injective.exchange.v1beta1.UpdateDenomDecimalsProposalR\x1bdenomDecimalsUpdateProposal\x12c\n" +
	"\x15fee_discount_proposal\x18\f \x01(\v2/.injective.exchange.v1beta1.FeeDiscountProposalR\x13feeDiscountProposal\x12\x87\x01\n" +
	"\"market_forced_settlement_proposals\x18\r \x03(\v2:.injective.exchange.v1beta1.MarketForcedSettlementProposalR\x1fmarketForcedSettlementProposals\x12s\n" +
	"\x1bdenom_min_notional_proposal\x18\x0e \x01(\v24.injective.exchange.v1beta1.DenomMinNotionalProposalR\x18denomMinNotionalProposal:U\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0**exchange/BatchExchangeModificationProposal\"\x96\x06\n" +
	...
	"\fmin_notional\x18\n" +
	" \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\vminNotional\x12D\n" +
	"\n" +
	"admin_info\x18\v \x01(\v2%.injective.exchange.v1beta1.AdminInfoR\tadminInfo\x12#\n" +
	"\rbase_decimals\x18\x0e \x01(\rR\fbaseDecimals\x12%\n" +
	"\x0equote_decimals\x18\x0f \x01(\rR\rquoteDecimals:L\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*!exchange/SpotMarketLaunchProposal\"\xa6\b\n" +
	...
	"\fmin_notional\x18\x0f \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\vminNotional\x12D\n" +
	"\n" +
	"admin_info\x18\x10 \x01(\v2%.injective.exchange.v1beta1.AdminInfoR\tadminInfo:Q\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*&exchange/PerpetualMarketLaunchProposal\"\xe5\a\n" +
	...
	"\x11admin_permissions\x18\x11 \x01(\rR\x10adminPermissions:U\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0**exchange/BinaryOptionsMarketLaunchProposal\"\xc6\b\n" +
	...
	"\x13min_price_tick_size\x18\x0e \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\x10minPriceTickSize\x12X\n" +
	"\x16min_quantity_tick_size\x18\x0f \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\x13minQuantityTickSize\x12F\n" +
	"\fmin_notional\x18\x10 \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\vminNotional\x12D\n" +
	"\n" +
	"admin_info\x18\x11 \x01(\v2%.injective.exchange.v1beta1.AdminInfoR\tadminInfo:U\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0**exchange/ExpiryFuturesMarketLaunchProposal\"\x92\n" +
	"\n" +
	...
	"\x06status\x18\r \x01(\x0e2(.injective.exchange.v1beta1.MarketStatusR\x06status\x12M\n" +
	"\roracle_params\x18\x0e \x01(\v2(.injective.exchange.v1beta1.OracleParamsR\foracleParams\x12\x1c\n" +
	"\x06ticker\x18\x0f \x01(\tB\x04\xc8\xde\x1f\x01R\x06ticker\x12F\n" +
	"\fmin_notional\x18\x10 \x01(\tB#\xc8\xde\x1f\x01\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\vminNotional\x12D\n" +
	"\n" +
	"admin_info\x18\x11 \x01(\v2%.injective.exchange.v1beta1.AdminInfoR\tadminInfo:W\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*,exchange/DerivativeMarketParamUpdateProposal\"N\n" +
	"\tAdminInfo\x12\x14\n" +
	...
	"\x10settlement_price\x18\x04 \x01(\tB#\xc8\xde\x1f\x01\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\x0fsettlementPrice:R\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*'exchange/MarketForcedSettlementProposal\"\xf8\x01\n" +
	"\x1bUpdateDenomDecimalsProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12P\n" +
	"\x0edenom_decimals\x18\x03 \x03(\v2).injective.exchange.v1beta1.DenomDecimalsR\rdenomDecimals:O\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*$exchange/UpdateDenomDecimalsProposal\"\xc2\b\n" +
	...
	"\x06status\x18\r \x01(\x0e2(.injective.exchange.v1beta1.MarketStatusR\x06status\x12U\n" +
	"\roracle_params\x18\x0e \x01(\v20.injective.exchange.v1beta1.ProviderOracleParamsR\foracleParams\x12\x1c\n" +
	"\x06ticker\x18\x0f \x01(\tB\x04\xc8\xde\x1f\x01R\x06ticker\x12F\n" +
	...
	"\rcampaign_info\x18\x03 \x01(\v25.injective.exchange.v1beta1.TradingRewardCampaignInfoR\fcampaignInfo\x12b\n" +
	"\x15campaign_reward_pools\x18\x04 \x03(\v2..injective.exchange.v1beta1.CampaignRewardPoolR\x13campaignRewardPools:W\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*,exchange/TradingRewardCampaignLaunchProposal\"\xfc\x03\n" +
	"#TradingRewardCampaignUpdateProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12Z\n" +
	"\rcampaign_info\x18\x03 \x01(\v25.injective.exchange.v1beta1.TradingRewardCampaignInfoR\fcampaignInfo\x12u\n" +
	"\x1fcampaign_reward_pools_additions\x18\x04 \x03(\v2..injective.exchange.v1beta1.CampaignRewardPoolR\x1ccampaignRewardPoolsAdditions\x12q\n" +
	"\x1dcampaign_reward_pools_updates\x18\x05 \x03(\v2..injective.exchange.v1beta1.CampaignRewardPoolR\x1acampaignRewardPoolsUpdates:W\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*,exchange/TradingRewardCampaignUpdateProposal\"\x80\x01\n" +
	"\x11RewardPointUpdate\x12'\n" +
	"\x0faccount_address\x18\x01 \x01(\tR\x0eaccountAddress\x12B\n" +
	"\n" +
	"new_points\x18\f \x01(\tB#\xc8\xde\x1f\x00\xda\xde\x1f\x1bcosmossdk.io/math.LegacyDecR\tnewPoints\"\xd7\x02\n" +
	...
	"\x14reward_point_updates\x18\x04 \x03(\v2-.injective.exchange.v1beta1.RewardPointUpdateR\x12rewardPointUpdates:\\\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*1exchange/TradingRewardPendingPointsUpdateProposal\"\xe3\x01\n" +
	"\x13FeeDiscountProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12K\n" +
	"\bschedule\x18\x03 \x01(\v2/.injective.exchange.v1beta1.FeeDiscountScheduleR\bschedule:G\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*\x1cexchange/FeeDiscountProposal\"\x85\x02\n" +
	"\x1fBatchCommunityPoolSpendProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12U\n" +
	"\tproposals\x18\x03 \x03(\v27.cosmos.distribution.v1beta1.CommunityPoolSpendProposalR\tproposals:S\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*(exchange/BatchCommunityPoolSpendProposal\"\xb3\x02\n" +
	".AtomicMarketOrderFeeMultiplierScheduleProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12e\n" +
	"\x16market_fee_multipliers\x18\x03 \x03(\v2/.injective.exchange.v1beta1.MarketFeeMultiplierR\x14marketFeeMultipliers:b\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*7exchange/AtomicMarketOrderFeeMultiplierScheduleProposal\"\xfe\x01\n" +
	"\x18DenomMinNotionalProposal\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\\\n" +
	"\x13denom_min_notionals\x18\x03 \x03(\v2,.injective.exchange.v1beta1.DenomMinNotionalR\x11denomMinNotionals:L\x88\xa0\x1f\x00\xe8\xa0\x1f\x00ʴ-\x1acosmos.gov.v1beta1.Content\x8a\xe7\xb0*!exchange/DenomMinNotionalProposal*x\n" +
	"\fExchangeType\x122\n" +
	"\x14EXCHANGE_UNSPECIFIED\x10\x00\x1a\x18\x8a\x9d \x14EXCHANGE_UNSPECIFIED\x12\x12\n" +
	"\x04SPOT\x10\x01\x1a\b\x8a\x9d \x04SPOT\x12 \n" +
	"\vDERIVATIVES\x10\x02\x1a\x0f\x8a\x9d \vDERIVATIVESBPZNgithub.com/InjectiveLabs/injective-core/injective-chain/modules/exchange/typesb\x06proto3"

var (
	file_injective_exchange_v1beta1_proposal_proto_rawDescOnce sync.Once
	file_injective_exchange_v1beta1_proposal_proto_rawDescData []byte
)

func file_injective_exchange_v1beta1_proposal_proto_rawDescGZIP() []byte {
	file_injective_exchange_v1beta1_proposal_proto_rawDescOnce.Do(func() {
		file_injective_exchange_v1beta1_proposal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_injective_exchange_v1beta1_proposal_proto_rawDesc), len(file_injective_exchange_v1beta1_proposal_proto_rawDesc)))
	})
	return file_injective_exchange_v1beta1_proposal_proto_rawDescData
}

var file_injective_exchange_v1beta1_proposal_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_injective_exchange_v1beta1_proposal_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_injective_exchange_v1beta1_proposal_proto_goTypes = []any{
	(ExchangeType)(0),                                      // 0: injective.exchange.v1beta1.ExchangeType
	(*SpotMarketParamUpdateProposal)(nil),                  // 1: injective.exchange.v1beta1.SpotMarketParamUpdateProposal
	(*ExchangeEnableProposal)(nil),                         // 2: injective.exchange.v1beta1.ExchangeEnableProposal
	(*BatchExchangeModificationProposal)(nil),              // 3: injective.exchange.v1beta1.BatchExchangeModificationProposal
	(*SpotMarketLaunchProposal)(nil),                       // 4: injective.exchange.v1beta1.SpotMarketLaunchProposal
	(*PerpetualMarketLaunchProposal)(nil),                  // 5: injective.exchange.v1beta1.PerpetualMarketLaunchProposal
	(*BinaryOptionsMarketLaunchProposal)(nil),              // 6: injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal
	(*ExpiryFuturesMarketLaunchProposal)(nil),              // 7: injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal
	(*DerivativeMarketParamUpdateProposal)(nil),            // 8: injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal
	(*AdminInfo)(nil),                                      // 9: injective.exchange.v1beta1.AdminInfo
	(*MarketForcedSettlementProposal)(nil),                 // 10: injective.exchange.v1beta1.MarketForcedSettlementProposal
	(*UpdateDenomDecimalsProposal)(nil),                    // 11: injective.exchange.v1beta1.UpdateDenomDecimalsProposal
	(*BinaryOptionsMarketParamUpdateProposal)(nil),         // 12: injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal
	(*ProviderOracleParams)(nil),                           // 13: injective.exchange.v1beta1.ProviderOracleParams
	(*OracleParams)(nil),                                   // 14: injective.exchange.v1beta1.OracleParams
	(*TradingRewardCampaignLaunchProposal)(nil),            // 15: injective.exchange.v1beta1.TradingRewardCampaignLaunchProposal
	(*TradingRewardCampaignUpdateProposal)(nil),            // 16: injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal
	(*RewardPointUpdate)(nil),                              // 17: injective.exchange.v1beta1.RewardPointUpdate
	(*TradingRewardPendingPointsUpdateProposal)(nil),       // 18: injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal
	(*FeeDiscountProposal)(nil),                            // 19: injective.exchange.v1beta1.FeeDiscountProposal
	(*BatchCommunityPoolSpendProposal)(nil),                // 20: injective.exchange.v1beta1.BatchCommunityPoolSpendProposal
	(*AtomicMarketOrderFeeMultiplierScheduleProposal)(nil), // 21: injective.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal
	(*DenomMinNotionalProposal)(nil),                       // 22: injective.exchange.v1beta1.DenomMinNotionalProposal
	(MarketStatus)(0),                                      // 23: injective.exchange.v1beta1.MarketStatus
	(types.OracleType)(0),                                  // 24: injective.oracle.v1beta1.OracleType
	(*DenomDecimals)(nil),                                  // 25: injective.exchange.v1beta1.DenomDecimals
	(*TradingRewardCampaignInfo)(nil),                      // 26: injective.exchange.v1beta1.TradingRewardCampaignInfo
	(*CampaignRewardPool)(nil),                             // 27: injective.exchange.v1beta1.CampaignRewardPool
	(*FeeDiscountSchedule)(nil),                            // 28: injective.exchange.v1beta1.FeeDiscountSchedule
	(*types1.CommunityPoolSpendProposal)(nil),              // 29: cosmos.distribution.v1beta1.CommunityPoolSpendProposal
	(*MarketFeeMultiplier)(nil),                            // 30: injective.exchange.v1beta1.MarketFeeMultiplier
	(*DenomMinNotional)(nil),                               // 31: injective.exchange.v1beta1.DenomMinNotional
}
var file_injective_exchange_v1beta1_proposal_proto_depIdxs = []int32{
	23, // 0: injective.exchange.v1beta1.SpotMarketParamUpdateProposal.status:type_name -> injective.exchange.v1beta1.MarketStatus
	9,  // 1: injective.exchange.v1beta1.SpotMarketParamUpdateProposal.admin_info:type_name -> injective.exchange.v1beta1.AdminInfo
	0,  // 2: injective.exchange.v1beta1.ExchangeEnableProposal.exchangeType:type_name -> injective.exchange.v1beta1.ExchangeType
	1,  // 3: injective.exchange.v1beta1.BatchExchangeModificationProposal.spot_market_param_update_proposals:type_name -> injective.exchange.v1beta1.SpotMarketParamUpdateProposal
	8,  // 4: injective.exchange.v1beta1.BatchExchangeModificationProposal.derivative_market_param_update_proposals:type_name -> injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal
	4,  // 5: injective.exchange.v1beta1.BatchExchangeModificationProposal.spot_market_launch_proposals:type_name -> injective.exchange.v1beta1.SpotMarketLaunchProposal
	5,  // 6: injective.exchange.v1beta1.BatchExchangeModificationProposal.perpetual_market_launch_proposals:type_name -> injective.exchange.v1beta1.PerpetualMarketLaunchProposal
	7,  // 7: injective.exchange.v1beta1.BatchExchangeModificationProposal.expiry_futures_market_launch_proposals:type_name -> injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal
	16, // 8: injective.exchange.v1beta1.BatchExchangeModificationProposal.trading_reward_campaign_update_proposal:type_name -> injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal
	6,  // 9: injective.exchange.v1beta1.BatchExchangeModificationProposal.binary_options_market_launch_proposals:type_name -> injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal
	12, // 10: injective.exchange.v1beta1.BatchExchangeModificationProposal.binary_options_param_update_proposals:type_name -> injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal
	11, // 11: injective.exchange.v1beta1.BatchExchangeModificationProposal.denom_decimals_update_proposal:type_name -> injective.exchange.v1beta1.UpdateDenomDecimalsProposal
	19, // 12: injective.exchange.v1beta1.BatchExchangeModificationProposal.fee_discount_proposal:type_name -> injective.exchange.v1beta1.FeeDiscountProposal
	10, // 13: injective.exchange.v1beta1.BatchExchangeModificationProposal.market_forced_settlement_proposals:type_name -> injective.exchange.v1beta1.MarketForcedSettlementProposal
	22, // 14: injective.exchange.v1beta1.BatchExchangeModificationProposal.denom_min_notional_proposal:type_name -> injective.exchange.v1beta1.DenomMinNotionalProposal
	9,  // 15: injective.exchange.v1beta1.SpotMarketLaunchProposal.admin_info:type_name -> injective.exchange.v1beta1.AdminInfo
	24, // 16: injective.exchange.v1beta1.PerpetualMarketLaunchProposal.oracle_type:type_name -> injective.oracle.v1beta1.OracleType
	9,  // 17: injective.exchange.v1beta1.PerpetualMarketLaunchProposal.admin_info:type_name -> injective.exchange.v1beta1.AdminInfo
	24, // 18: injective.exchange.v1beta1.BinaryOptionsMarketLaunchProposal.oracle_type:type_name -> injective.oracle.v1beta1.OracleType
	24, // 19: injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal.oracle_type:type_name -> injective.oracle.v1beta1.OracleType
	9,  // 20: injective.exchange.v1beta1.ExpiryFuturesMarketLaunchProposal.admin_info:type_name -> injective.exchange.v1beta1.AdminInfo
	23, // 21: injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal.status:type_name -> injective.exchange.v1beta1.MarketStatus
	14, // 22: injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal.oracle_params:type_name -> injective.exchange.v1beta1.OracleParams
	9,  // 23: injective.exchange.v1beta1.DerivativeMarketParamUpdateProposal.admin_info:type_name -> injective.exchange.v1beta1.AdminInfo
	25, // 24: injective.exchange.v1beta1.UpdateDenomDecimalsProposal.denom_decimals:type_name -> injective.exchange.v1beta1.DenomDecimals
	23, // 25: injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal.status:type_name -> injective.exchange.v1beta1.MarketStatus
	13, // 26: injective.exchange.v1beta1.BinaryOptionsMarketParamUpdateProposal.oracle_params:type_name -> injective.exchange.v1beta1.ProviderOracleParams
	24, // 27: injective.exchange.v1beta1.ProviderOracleParams.oracle_type:type_name -> injective.oracle.v1beta1.OracleType
	24, // 28: injective.exchange.v1beta1.OracleParams.oracle_type:type_name -> injective.oracle.v1beta1.OracleType
	26, // 29: injective.exchange.v1beta1.TradingRewardCampaignLaunchProposal.campaign_info:type_name -> injective.exchange.v1beta1.TradingRewardCampaignInfo
	27, // 30: injective.exchange.v1beta1.TradingRewardCampaignLaunchProposal.campaign_reward_pools:type_name -> injective.exchange.v1beta1.CampaignRewardPool
	26, // 31: injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal.campaign_info:type_name -> injective.exchange.v1beta1.TradingRewardCampaignInfo
	27, // 32: injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal.campaign_reward_pools_additions:type_name -> injective.exchange.v1beta1.CampaignRewardPool
	27, // 33: injective.exchange.v1beta1.TradingRewardCampaignUpdateProposal.campaign_reward_pools_updates:type_name -> injective.exchange.v1beta1.CampaignRewardPool
	17, // 34: injective.exchange.v1beta1.TradingRewardPendingPointsUpdateProposal.reward_point_updates:type_name -> injective.exchange.v1beta1.RewardPointUpdate
	28, // 35: injective.exchange.v1beta1.FeeDiscountProposal.schedule:type_name -> injective.exchange.v1beta1.FeeDiscountSchedule
	29, // 36: injective.exchange.v1beta1.BatchCommunityPoolSpendProposal.proposals:type_name -> cosmos.distribution.v1beta1.CommunityPoolSpendProposal
	30, // 37: injective.exchange.v1beta1.AtomicMarketOrderFeeMultiplierScheduleProposal.market_fee_multipliers:type_name -> injective.exchange.v1beta1.MarketFeeMultiplier
	31, // 38: injective.exchange.v1beta1.DenomMinNotionalProposal.denom_min_notionals:type_name -> injective.exchange.v1beta1.DenomMinNotional
...
func init() { file_injective_exchange_v1beta1_proposal_proto_init() }
func file_injective_exchange_v1beta1_proposal_proto_init() {
	if File_injective_exchange_v1beta1_proposal_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_injective_exchange_v1beta1_proposal_proto_rawDesc), len(file_injective_exchange_v1beta1_proposal_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_injective_exchange_v1beta1_proposal_proto_goTypes,
		DependencyIndexes: file_injective_exchange_v1beta1_proposal_proto_depIdxs,
		EnumInfos:         file_injective_exchange_v1beta1_proposal_proto_enumTypes,
		MessageInfos:      file_injective_exchange_v1beta1_proposal_proto_msgTypes,
	}.Build()
	File_injective_exchange_v1beta1_proposal_proto = out.File
	file_injective_exchange_v1beta1_proposal_proto_goTypes = nil
	file_injective_exchange_v1beta1_proposal_proto_depIdxs = nil
}
