...
var (
	...
	ErrInvalidOwnerEquity  = errors.Register(ModuleName, 12, "invalid owner equity percent")
	ErrVerifierRestriction = errors.Register(ModuleName, 13, "verifier account cannot create nft, product")
)
