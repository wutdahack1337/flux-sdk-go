...
type MsgCreate struct {
	...
	OwnerEquityPercent cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=owner_equity_percent,json=ownerEquityPercent,proto3,customtype=cosmossdk.io/math.Int" json:"owner_equity_percent" bson:"ownerEquityPercent"`
	...
	ISOSuccessPercent uint64 `protobuf:"varint,7,opt,name=ISO_success_percent,json=ISOSuccessPercent,proto3" json:"ISO_success_percent,omitempty"`
	// accepted_sponsorship_denoms defines accepted denoms for sponsorship
	AcceptedPaymentDenom string `protobuf:"bytes,8,opt,name=accepted_payment_denom,json=acceptedPaymentDenom,proto3" json:"accepted_payment_denom,omitempty"`
	// dividend_interval defines period to distribute dividend to shareholders
	DividendInterval uint64 `protobuf:"varint,9,opt,name=dividend_interval,json=dividendInterval,proto3" json:"dividend_interval,omitempty"`
}
...
var fileDescriptor_2058add415fce8f9 = []byte{
	...
	,
}
