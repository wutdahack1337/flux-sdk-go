...
type DenomLink struct {
	...
	SrcDenom string `protobuf:"bytes,3,opt,name=src_denom,json=srcDenom,proto3" json:"src_denom,omitempty"`
	DstDenom string `protobuf:"bytes,4,opt,name=dst_denom,json=dstDenom,proto3" json:"dst_denom,omitempty"`
}
...
func (m *DenomLink) GetSrcDenom() string {
	if m != nil {
		return m.SrcDenom
	}
	return ""
...
func (m *DenomLink) GetDstDenom() string {
	if m != nil {
		return m.DstDenom
	}
	return ""
...
var fileDescriptor_56a2028c7fe76419 = []byte{
	...
	,
}
...
func (m *DenomLink) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DstDenom) > 0 {
		...
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.DstDenom)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.SrcDenom) > 0 {
		...
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.SrcDenom)))
		i--
		dAtA[i] = 0x1a
	}
	if m.DstPlane != 0 {
