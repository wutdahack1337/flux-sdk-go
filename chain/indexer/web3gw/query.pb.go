...
type FaucetSendRequest struct {
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
}

func (m *FaucetSendRequest) Reset()         { *m = FaucetSendRequest{} }
func (m *FaucetSendRequest) String() string { return proto.CompactTextString(m) }
func (*FaucetSendRequest) ProtoMessage()    {}
func (*FaucetSendRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_eb8009f4ae0c1d99, []int{6}
}
func (m *FaucetSendRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FaucetSendRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FaucetSendRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FaucetSendRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FaucetSendRequest.Merge(m, src)
}
func (m *FaucetSendRequest) XXX_Size() int {
	return m.Size()
}
func (m *FaucetSendRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FaucetSendRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FaucetSendRequest proto.InternalMessageInfo

func (m *FaucetSendRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type FaucetSendResponse struct {
}

func (m *FaucetSendResponse) Reset()         { *m = FaucetSendResponse{} }
func (m *FaucetSendResponse) String() string { return proto.CompactTextString(m) }
func (*FaucetSendResponse) ProtoMessage()    {}
func (*FaucetSendResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_eb8009f4ae0c1d99, []int{7}
}
func (m *FaucetSendResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FaucetSendResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FaucetSendResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FaucetSendResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FaucetSendResponse.Merge(m, src)
}
func (m *FaucetSendResponse) XXX_Size() int {
	return m.Size()
}
func (m *FaucetSendResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_FaucetSendResponse.DiscardUnknown(m)
}

var xxx_messageInfo_FaucetSendResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*FaucetSendRequest)(nil), "flux.indexer.web3gw.FaucetSendRequest")
	proto.RegisterType((*FaucetSendResponse)(nil), "flux.indexer.web3gw.FaucetSendResponse")
}
...
var fileDescriptor_eb8009f4ae0c1d99 = []byte{
	...
	,
}
...
type APIClient interface {
	...
	FaucetSend(ctx context.Context, in *FaucetSendRequest, opts ...grpc.CallOption) (*FaucetSendResponse, error)
}
...
func (c *aPIClient) FaucetSend(ctx context.Context, in *FaucetSendRequest, opts ...grpc.CallOption) (*FaucetSendResponse, error) {
	out := new(FaucetSendResponse)
	err := c.cc.Invoke(ctx, "/flux.indexer.web3gw.API/FaucetSend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	FaucetSend(context.Context, *FaucetSendRequest) (*FaucetSendResponse, error)
}
...
func (*UnimplementedAPIServer) FaucetSend(ctx context.Context, req *FaucetSendRequest) (*FaucetSendResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FaucetSend not implemented")
}
...
func _API_FaucetSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FaucetSendRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).FaucetSend(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flux.indexer.web3gw.API/FaucetSend",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).FaucetSend(ctx, req.(*FaucetSendRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _API_FaucetSend_Handler,
		},
	},
...
func (m *FaucetSendRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FaucetSendRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FaucetSendRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FaucetSendResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FaucetSendResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FaucetSendResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *FaucetSendRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FaucetSendResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FaucetSendRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FaucetSendRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FaucetSendRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FaucetSendResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FaucetSendResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FaucetSendResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
